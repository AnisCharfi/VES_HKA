...
public class Stretch2 : MonoBehaviour
{
    ...
    void Update()
    {
        if(animation1 == true){
            ...
            float newZScale = amplitude2 * Mathf.Sin(frequency * CurrentTime + fase + 3.14f);
            ...
            transform.localScale = new Vector3(currentScale.x, currentScale.y, currentScale2.z + newZScale);
